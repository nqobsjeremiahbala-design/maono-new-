  ...
  return (
    <>
      ...
      <section className="bg-navy-950 relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-6 md:px-10 py-14 sm:py-16 md:py-24 grid md:grid-cols-[1fr_380px] gap-10 md:gap-16 items-start">
          <div className="hero-reveal">
            ...
            <h1 className="font-serif text-[2.25rem] sm:text-4xl md:text-5xl lg:text-6xl text-white leading-[1.08] mb-5 sm:mb-6">
              {meta!.title}
            </h1>
            <p className="text-navy-300 text-base sm:text-lg md:text-xl leading-relaxed mb-8 md:mb-10 max-w-2xl">
              {meta!.description}
            </p>
      ...
      <section className="bg-white py-16 md:py-28 px-5 sm:px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-[1.3fr_1fr] gap-10 md:gap-16 items-start mb-16 md:mb-20">
            <div>
              <p className="text-gold-600 text-xs font-semibold tracking-[0.2em] uppercase mb-4 sm:mb-5">What you’ll learn</p>
              <h2 className="font-serif text-3xl sm:text-4xl text-navy-900 leading-[1.1] mb-6 sm:mb-8">
          ...
          {curriculum && (
            <div className="mb-16 md:mb-20">
              <p className="text-gold-600 text-xs font-semibold tracking-[0.2em] uppercase mb-4 sm:mb-5">The curriculum</p>
              <h2 className="font-serif text-3xl sm:text-4xl text-navy-900 leading-[1.1] mb-8 md:mb-10">
                ...
                {curriculum.modules.map((m, mi) => (
                  <li key={mi}>
                    ...
                    <ul className="divide-y divide-navy-100 border-t border-b border-navy-100">
                      {m.lessons.map(l => (
                        <li key={l.slug} className="py-4 flex items-start gap-3 sm:gap-4">
                          <span
                          ...
                          <span className="flex-1 min-w-0">
                            ...
                            <span className="sm:hidden block text-xs text-navy-400 tabular-nums mt-1.5">
                              {l.type === 'video' ? 'Video' : 'Read'} · {l.duration}
                            </span>
                          </span>
                          <span className="hidden sm:block shrink-0 text-xs text-navy-400 tabular-nums pt-1">
                            {l.type === 'video' ? 'Video' : 'Read'} · {l.duration}
                          </span>
                        </li>
                      ))}
          ...
          <div>
            <p className="text-gold-600 text-xs font-semibold tracking-[0.2em] uppercase mb-4 sm:mb-5">About this course</p>
