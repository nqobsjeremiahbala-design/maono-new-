  ...
  return (
    <section className="relative bg-navy-950 overflow-hidden min-h-[620px] md:min-h-dvh flex">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 md:hidden bg-gradient-to-b from-navy-950/10 via-navy-950/60 to-navy-950" />
        <div className="hidden md:block absolute inset-0 bg-gradient-to-r from-navy-950 via-navy-950/85 to-navy-950/10" />
      </div>
      ...
      <div className="relative w-full max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-10 md:pt-32 md:pb-36 flex items-end md:items-center">
        <div className="max-w-2xl hero-reveal w-full">
          <h1 className="font-serif font-extrabold text-[2.75rem] leading-[1.02] sm:text-5xl md:text-6xl lg:text-7xl text-white mb-4 md:mb-6 tracking-tight">
            Forex education<br />
            <span className="text-gold-400">without the noise.</span>
          </h1>
          <p className="text-white/90 font-semibold text-lg sm:text-xl md:text-2xl mb-6 md:mb-10 max-w-xl">
